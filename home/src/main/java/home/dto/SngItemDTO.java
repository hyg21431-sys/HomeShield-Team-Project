...
public class SngItemDTO implements Serializable{
	...
	private String houseType;			// 주택 유형 (단독 또는 다가구)
	...
	private String totalFloorAr;		// 주택의 전체 연면적 (제곱미터, m²)
	private String umdNm;				// 읍면동 행정 구역 이름 (예: 둔산동)
	@JsonIgnore
